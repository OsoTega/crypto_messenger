...
const ServiceCard = ({ color, title, icon, subtitle }) => {
    return (
        <div className="flex flex-row justify-start
         items-center white-glassmorphism p-3 m-2 cursor-pointer hover:shadow-xl">
            <div className={`w-10 h-10 rounded-full flex 
            justify-center items-center ${color}`}>
                {icon}
            </div>
        ...
        <div className="flex flex-col lg:flex-row w-full justify-center items-center gradient-bg-services">
            ...
            <div className="flex-1 flex flex-col justify-start items-center">
                <ServiceCard
                    ...
                    subtitle="Security is guaranteed. We always maintain 
                    privacy and quality of our products"
                />
                <ServiceCard
                    color="bg-[#8945F8]"
